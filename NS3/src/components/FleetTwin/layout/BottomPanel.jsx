...
const metrics = [
  {
    ...
    data: [3.4, 3.1, 3.3, 2.9, 3.0, 3.4, 3.6, 3.2, 3.1, 3.5, 3.3, 3.0, 2.8, 3.1, 3.2, 3.4, 3.1, 2.9, 3.0, 3.2, 3.3, 3.1, 3.0, 2.9],
  },
  {
    id: "radar",
    icon: <Radar size={14} />,
    ...
    data: [93, 94, 94, 95, 94, 95, 96, 95, 96, 96, 95, 96, 97, 96, 96, 95, 96, 96, 97, 96, 96, 95, 96, 96],
  },
  {
    id: "latency",
    icon: <Wifi size={14} />,
    ...
    deltaDown: false,
    color: "var(--accent-blue)",
    data: [38, 34, 36, 31, 29, 33, 30, 28, 32, 27, 29, 31, 28, 26, 30, 28, 27, 29, 28, 26, 28, 27, 29, 28],
  },
];
