import {
  Anchor, Cog, Zap, Radar, Waves, Eye, Crosshair,
  Target, Rocket, Radio, Box, Plus,
} from "lucide-react";
...
const PARENT_CONFIG: Record<string, { icon: ReactNode; id: string; addable: boolean }> = 
{
...
const SidebarLeft = ({ onLogout }: SidebarProps) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await apiClient.get<ComponentItem[]>("/components/list-components");
